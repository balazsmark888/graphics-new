...
GLboolean ShaderProgram::SetUniformVariable1fv(const GLchar *name,
                                               GLsizei count,
...
GLboolean ShaderProgram::SetUniformVariable2fv(const GLchar *name,
                                               GLsizei count,
                                               const GLfloat *value) const
{
    if (!_program)
...
GLboolean ShaderProgram::SetUniformVariable3fv(const GLchar *name,
                                               GLsizei count,
                                               const GLfloat *value) const
{
    if (!_program)
...
GLboolean ShaderProgram::SetUniformVariable4fv(const GLchar *name,
                                               GLsizei count,
                                               const GLfloat *value) const
{
    if (!_program)
...
GLboolean ShaderProgram::SetUniformVariable1iv(const GLchar *name,
                                               GLsizei count,
...
GLboolean ShaderProgram::SetUniformVariable2iv(const GLchar *name,
                                               GLsizei count,
                                               const GLint *value) const
{
    if (!_program)
...
GLboolean ShaderProgram::SetUniformVariable3iv(const GLchar *name,
                                               GLsizei count,
                                               const GLint *value) const
{
    if (!_program)
...
GLboolean ShaderProgram::SetUniformVariable4iv(const GLchar *name,
                                               GLsizei count,
                                               const GLint *value) const
{
    if (!_program)
...
GLboolean ShaderProgram::SetUniformMatrix2fv(const GLchar *name,
                                             GLsizei count,
                                             GLboolean transpose,
                                             const GLfloat *value) const
{
...
GLboolean ShaderProgram::SetUniformMatrix3fv(const GLchar *name,
                                             GLsizei count,
                                             GLboolean transpose,
                                             const GLfloat *value) const
{
...
GLboolean ShaderProgram::SetUniformMatrix4fv(const GLchar *name,
                                             GLsizei count,
                                             GLboolean transpose,
                                             const GLfloat *value) const
{
