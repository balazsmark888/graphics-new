...
namespace cagd
{
	...
	inline GLvoid DCoordinate3::setx(GLdouble value)
	{
		_data[0] = value;
	}

	inline GLvoid DCoordinate3::sety(GLdouble value)
	{
		_data[1] = value;
	}

	inline GLvoid DCoordinate3::setz(GLdouble value)
	{
		_data[2] = value;
	}
	...
	{
		// homework
		return DCoordinate3(_data[0] - rhs._data[0],
			_data[1] - rhs._data[1],
			_data[2] - rhs._data[2]);
	}
